...
# 1 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stddef.h" 1 3 4
# 213 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stddef.h" 3 4
...
# 1 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stddef.h" 1 3 4
# 325 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stddef.h" 3 4
typedef long int wchar_t;
# 354 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stddef.h" 3 4
...
# 1 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stdarg.h" 1 3 4
# 43 "/usr/lib/gcc-lib/i586-suse-linux/3.3.3/include/stdarg.h" 3 4
...
void c(int one, int two, int three)
{
  ...
  y = 2;
  z = 3;
  fprintf(stderr, "in c(0x%x, 0x%x, 0x%x) ebp=%p  esp=%p\n", one, two, three, ({unsigned long _s_;__asm__ __volatile__("movl %%ebp,%0" : "=r" (_s_)); _s_;}), ({unsigned long _s_;__asm__ __volatile__("movl %%esp,%0" : "=r" (_s_)); _s_;}));
