...
# . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
global traceit_fd
traceit_fd = open("traceit_output", "a")
# . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
def traceit_lines_m4(frame, event, arg):
    global traceit_fd
    ...
    print('  %s:%s:%s' % (filename,line_no,func_name), file=traceit_fd)
# . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
def traceit_m4(frame, event, arg):
    global traceit_fd
    ...
    print('Call to %s on line %s of %s from line %s of %s' %
        (func_name, func_line_no, func_filename, caller_line_no, caller_filename), file=traceit_fd)
    if func_filename in ("./trace-test.py"):
         # Trace into this function
         return traceit_lines_m4
    return
# . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
sys.settrace(traceit_m4)
#-----------------------------------------------------------------------------
    ...
    while True:
        try:
            ...
            try:
                ...
                print("Parsing error in line '%s'" % input)
                print("    ", str(ex))
                continue
            except:
                print("Parsing error in line '%s'" % input)
