...
//    if (seteuid(uid) == -1)
//    {
//        perror("Cannot change effective user id");
//        exit(2);
//    }
    if (setreuid(uid,uid) == -1)
    {
        perror("Cannot change real and effective user id");
        exit(2);
    }
...
//    if (setegid(gid) == -1)
//    {
//        perror("Cannot change effective group id");
//        exit(2);
//    }
    if (setregid(gid,gid) == -1)
    {
        perror("Cannot change real and effective group id");
        exit(2);
    }
