...
int ctocopy[64];		/* channels to copy */
...
int i;
printf("trk = %d  ",n);
for (i=0;i<64;i++) printf(" %d",haschannel[i]);
printf("\n");
}
...
main (int argc, char *argv[])
{
  ...
  for (i = 0; i < 64; i++)
    ctocopy[i] = 1;
  for (i=0;i<64;i++) tfocus[i] = 0;  /* [SS] 2017-11-27 */
  for (i=0;i<64;i++) cfocus[i] = 0;  /* [SS] 2017-11-27 */
  for (i=0;i<64;i++) hastempo[i] = 0; /* [SS] 2017-12-14 */
  mtrks = 0;
  xtrks = 0;
  chns = 0;
  xchns = 0;
