...
# Initial revision
#
# Revision 1.1  2002/01/31 20:51:50  SwatoshT
# Added command line options to allow looping and skipping of tests (create VCG only.
#
# Revision 1.1  2002/01/22 16:35:24  SwatoshT
# Added initial 2-way regression script.
#
# Revision 1.5  2001/11/30 20:46:39  RysavyR
# Added many additional tests.
#
# Revision 1.4  2001/11/29 16:39:57  NigburC
# Updated the test to add the timestamp to the log file name and display
# the log file name in the opening information.
#
# Revision 1.3  2001/11/29 13:24:03  NigburC
# Updated the log file name used for the regression test and fixed the
# problem with displaying log information (missing undef for the output
# file name).
#
# Revision 1.2  2001/11/15 17:04:36  NigburC
# Updated the regression bucket to handle more things.
#
# Revision 1.1  2001/11/14 18:58:24  NigburC
# Initial integration.
#
##############################################################################
