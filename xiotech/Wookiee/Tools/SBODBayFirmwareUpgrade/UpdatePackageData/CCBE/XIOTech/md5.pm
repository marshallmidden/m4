...
#
# Purpose:
#   MD5 encapsulation code.
##############################################################################

#package Digest::Perl::MD5;
#Changed so that we could control the install location
package XIOTech::md5;
use strict;
use integer;
use Exporter;
...
# Initial revision
#
# Revision 1.4  2003/02/11 17:28:53  WerningJ
# Changed SelfLoader DATA into an Array
# to avoid open filehandles and runtime errors using perlapp
# reviewed by Chris N
#
