...
# Initial revision
#
# Revision 1.5  2003/06/10 18:26:21  NigburC
# TBolt00000000 - Fixed the problem with running the CCBCL and Perl 5.8.  It
# seems that our big number code was not using Perl properly or Perl changed
# its default behavior with the new release.
# Reviewed by Tim Swatosh.
#
# Revision 1.4  2001/12/07 18:54:21  NigburC
# Added the bigIntToHex method.
#
