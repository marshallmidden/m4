...
use constant PI_ERROR_DOUBLE_POOL           => 0x44;  # Bay in multiple pools             
use constant PI_ERROR_GEORAID_IN_BAY        => 0x45;  # Bay has drive in pool             
use constant PI_ERROR_GEO_MISMATCH          => 0x46;  # Expansion attempt mismatch w/ geoRAID
...
use constant PI_ERROR_GEO_INV_TYPE          => 0x4A;  # Invalid RAID type for geo-RAID
...
$msgErrCode[PI_ERROR][PI_ERROR_DOUBLE_POOL]
    = "Bay in multiple pools";

$msgErrCode[PI_ERROR][PI_ERROR_GEORAID_IN_BAY]
    = "Bay has drive in pool";

$msgErrCode[PI_ERROR][PI_ERROR_GEO_MISMATCH]
    = "Expansion attempt mismatch w/ geoRAID";
...
$msgErrCode[PI_ERROR][PI_ERROR_GEO_INV_TYPE]
    = "Invalid RAID type for geo-RAID";
