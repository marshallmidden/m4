...
sub BuildCmdCodeHashTables 
{
    ...
    $pktDataH{ 0x0212 } = "GEOPOOL_GET";
    $pktDataH{ 0x0213 } = "GEOPOOL_SET";
    ...
    $logDataH{ 0x0072 } = "GEOPOOL_CHANGED";
    ...
    $logDataH{ 0x018D } = "MOVING_TARGETS";
    $logDataH{ 0x018E } = "PROC_PRINTF";
    ...
    $x1DataH{ 0x69 } = "GET_GEOPOOL_INFO";
    $x1DataH{ 0x6A } = "SET_GEOPOOL_INFO";
...
# Change log:
# $Log$
# Revision 1.2  2006/07/27 15:14:20  HoltyB
# TBolt00014970
# Checking in additional debug gathering for this defect:
# 1. Added trace event for PAM HB success and failure.
# 2. Added debug log message for PAM HB failure.
#
# Revision 1.1.1.1  2005/05/04 18:53:54  RysavyR
# import CT1_BR to shared/Wookiee
#
# Revision 1.11  2005/02/14 20:29:00  RysavyR
# TBolt00012264: Updates to pick up new log messages, tracepoints etc.
#
# Revision 1.5  2004/02/16 22:48:49  RysavyR
...
#
# Revision 1.4  2003/11/21 20:39:23  RysavyR
# TracDec updates to pick up new log messages, tracepoints etc.
#
# Revision 1.3  2002/11/25 17:56:07  RysavyR
# TBolt00006344: Fix up RM tracing.
#
# Revision 1.2  2002/11/25 16:25:39  NigburC
# TBolt00006352 - Added trace event points to the RM code to help determine
# where time is being spent.
# Reviewed by Randy Rysavy.
#
# Revision 1.1  2002/11/21 21:16:02  RysavyR
# TBolt00000000: Updates to TracDec.pl and associated tools.
#
##############################################################################
#
# Modelines:
