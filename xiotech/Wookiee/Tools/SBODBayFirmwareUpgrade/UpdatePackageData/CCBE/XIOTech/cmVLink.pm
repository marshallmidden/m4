...
sub displayVirtualLinks
{
    ...
    for (my $i = 0; $i < $info{COUNT}; $i++)
    {
        ...
        {
            $msg .= sprintf(" %3hu  0x%4.4x  %14s  %10hu  %7hu  %5hu  %3hu\n", 
                            $info{LIST}[$i]{VID},
                            $info{LIST}[$i]{ATTR},
    ...
    for (my $i = 0; $i < $info{COUNT}; $i++)
    {
        ...
        {
            $msg .= sprintf(" %3hu  0x%4.4x  %14s  %8.8x%8.8x  %6hu\n", 
                            $info{LIST}[$i]{VID},
                            $info{LIST}[$i]{ATTR},
                            $info{LIST}[$i]{CAPACITY},
                            $info{LIST}[$i]{WWN_LO}, 
...
#
# Revision 1.15  2003/12/11 15:25:07  NigburC
# TBolt00000000 - Added new VLINKS command to the CCBCL and CCBE.
# Reviewed by Tim Swatosh (virtually).
#
# Revision 1.14  2003/07/01 18:47:53  SchibillaM
# TBolt00008588: Fix bug in VLINKDLINKINFO to make it agree with
# X1VLINKINFO.
#
# Revision 1.13  2003/04/21 17:48:20  SchibillaM
# TBolt00008133: Fix VLink Info based on changes to proc and ccb data struct.
#
# Revision 1.12  2003/04/11 17:39:28  SchibillaM
# TBolt00007915: Add PI support for  X1 DLink and Dlock info.
#
# Revision 1.11  2003/03/27 15:18:51  SchibillaM
# TBolt00007915: Add X1 support for VLink commands - VLinked To, VLink LUN
# Info and VLink Storage Unit Info.
#
# Revision 1.10  2002/12/23 16:55:58  NigburC
# TBolt00000000 - Updated the vlink info request to match PROC changes.
# Reviewed by Jeff Williams.
#
# Revision 1.9  2002/10/08 13:07:25  HoltyB
# TBolt00006093:  Changed vlinkCreate to allow setting the VID explicitly.
# If VID is not defined the first available VID is determined and used.
#
# Revision 1.8  2002/09/16 16:52:45  SchibillaM
...
#
# Revision 1.7  2002/09/03 14:32:52  SchibillaM
...
#
# Revision 1.6  2002/05/30 18:25:24  HoltyB
# Fixed _virtualLinkInfoPacket, offset off in ldd info.
#
# Revision 1.5  2002/05/30 17:20:26  HoltyB
# Fixed _virtualLinkInfoPacket, It was not reading enough data to fill in the
# RDD information
#
# Revision 1.4  2002/03/27 13:11:13  SchibillaM
...
#
# Revision 1.2  2001/12/19 14:12:40  NigburC
# Fixed the display of the virtual link viritual disks information.  I did not complete
# the printf statement for some of the values.
#
